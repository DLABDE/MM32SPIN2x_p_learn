...
{ 		
	...
	RCC_AHBPeriphClockCmd(GPIO_OLED_CLK, ENABLE);  									    
	...
	GPIO_Init(OLEDGPIOx, &GPIO_OLEDInitStruct);                      				
 	GPIO_SetBits(OLEDGPIOx, GPIO_OLED_SCLK_Pin|GPIO_OLED_PIN_Pin|GPIO_OLED_RES_Pin|GPIO_OLED_DC_Pin);
